...
- Surveys and books:
<<<<<<< HEAD
	- E BERT D. S., W ORLEY S., M USGRAVE F. K., P EACHEY D., P ERLIN K.: Texturing & Modeling, a Procedural Approach, 3rd ed. Elsevier, 2003.
	- L AGAE A., L EFEBVRE S., C OOK R., D E R OSE T., D RETTAKIS G., E BERT D., L EWIS J., P ERLIN K., Z WICKER M.: State of the art in procedural noise function. EG'10
=======
...
>>>>>>> 1fec088e0f90afb649fe0559a0ce9279a412dce2
...
- **L-System**: Aristid Lindenmayer. Mathematical models for cellular interactions in development. Journal of theoretical biology 1968
	- First PM paper;
<<<<<<< HEAD
- P ERLIN K.: An image synthesizer. SIGGRAPH'85
...
- Terrain: noise-based, physics-based;
	- Fractal: M ANDELBROT B. B.: The Fractal Geometry of Nature. W. H. Freeman, 1982
		- Height (limitation: can't handle overhangs and caves)
	- M USGRAVE F. K., K OLB C. E., M ACE R. S.: The synthesis and rendering of eroded fractal terrains. SIGGRAPH'89
		- Physics-based: Erosion;
	- B ENES B., F ORSBACH R.: Layered data representation for visual simulation of terrain erosion. SCCG'01
	- S AUNDERS R. L.: Terrainosaurus: Realistic Terrain Synthesis Using Genetic Algorithms. 06
		- AI-based? DEM-based
	- P EYTAVIE A., G ALIN E., G ROSJEAN J., M ERILLOU S.: Arches: a framework for modeling complex terrains. CGF'09
=======
...
<<<<<<< HEAD
	...
	- I JIRI T., O WADA S., I GARASHI T.: Seamless integration of initial sketching and subsequent detail editing in flower modeling. Computer Graphics Forum 25, 3 (2006), 617–624. 5, 13 P RUSINKIEWICZ P.: Treesketch: Interactive modeling of trees on a tablet. In Proceedings of the Eurographics Symposium on Sketch-Based Interfaces and Modeling (2012), Eurographics, pp. 107–120. 13
	- I JIRI T., O WADA S., I GARASHI T.: The sketch L-System: Global control of tree modeling using free-form strokes. In Smart Graphics (2006), pp. 138–146. 5, 13
	- LIVNY Y., Y AN F., O LSON M., C HEN B., Z HANG H., E L -S ANA J.: Automatic reconstruction of tree skeletal structures from point clouds. TOG'10
	- **SpeedTree**: INTERACTIVE DATA VISUALIZATION , I NC .: SpeedTree. 13
		- http://www.speedtree.com/
	- **plastic trees**: P IRK S., S TAVA O., K RATT J., S AID M. A. M., N EU BERT B., M ĚCH R., B ENES B., D EUSSEN O.: Plastic trees: interactive self-adapting botanical tree models. SIGGRAPH'12
=======
...
<<<<<<< HEAD
	- **DEM**: B RUNETON E., N EYRET F.: Real-time rendering and editing of vector-based terrains. CGF'08
	- M C C RAE J., S INGH K.: Sketch-based path design. GI'09: Proceedings of Graphics Interface 2009
=======
...
<<<<<<< HEAD
	- SUN J., Y U X., B ACIU G., G REEN M.: Template- based generation of road networks for virtual city modeling. VRST'02
		- Several frequent patterns in real road networks and use them as basic building blocks;
	- L ECHNER T., W ATSON B., W ILENSKY U.: Procedural city modeling. 03
	...
	- KELLY G., M C C ABE H.: A survey of procedural techniques for city generation. 06
	...
	- CHEN G., E SCH G., WONKA P., M ÜLLER P., Z HANG E.: Interactive procedural street modeling. SIGGRAPH'08
=======
...
<<<<<<< HEAD
	- YONG L., CONGFU X., ZHIGENG P., YUNHE P.: Semantic modeling project: Building vernacular house of southeast china. VRCAI'04
	...
	- FINKENZELLER D., B ENDER J.: Semantic representation of complex building structures. CGV'08
	- FINKENZELLER D.: Detailed building façades. CGA'08
	- PATOW G.: User-friendly graph editing for procedural modeling of buildings. CGA'12
	- MERRELL P., S CHKUFZA E., KOLTUN V.: Computer-generated residential building layouts. TOG'10
		- **Bayesian Network** for generation;
	- Facade generation: 2D-split grammar;
		- Muller P., Zeng G., Wonka P., G OOL L. V.: Image-based procedural modeling of facades. SIGGRAPH'07
		- Forward: XIAO J., F ANG T., TAN P., ZHAO P., O FEK E., QUAN L.: Image-based facade modeling. TOG'08
		- Inverse: Bao F., S CHWARZ M., WONKA P.: Procedural facade variations from a single layout. TOG'13
		- ZHANG H., X U K., J IANG W., L IN J., COHEN-OR D., CHEN B.: Layered analysis of irregular facades via symmetry. TOG'13
		- parametric context-free split grammar:
- Furniture, building interior:
	- Problem: floor Plan; furniture layouts; room subdivision;
	- RAU-CHAPLIN A., MACKAY-LYONS B., SPIERENBURG P. F.: The lahave house project: Towards an automated architectural design service. CADEX'96
	...
	- HAHN E., B OSE P., W HITEHEAD A.: Persistent real-time building interior generation. SIGGRAPH'06
	...
	- **squarified treemaps**: M ARSON F., M USSE S. R.: Automatic generation of floor plans based on squarified treemaps algorithm. 2010
