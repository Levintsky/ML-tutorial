...
- (AATA Chap-19) Lattices and Boolean Algebras
	- Lattices
		...
		- def. 良序 **well-ordered set**: Poset with minimum;
...
- The Simplicity of An 置换群
	- Def: 单群: simple groups. 没有非平凡正规子群, 只有(e)和自身.
		- e.g. 素数阶循环群Zp.
	- Lemma 6.1.1 两对换的复合是3-cycle或两3-cycle复合
		— Proof: τ1τ1=e, one item in common: (12)(13)=(132), two: (12)(34)=(142)(143).
	- Lemma 6.1.2 Sn中的偶置换σ可由3-cycle的复合表达, i.e., 3-cycle生成交错群An.
	- Lemma 6.1.3 n>=5, Sn中两3-cycle在An中共轭.
	- Theo 6.1.7 n>=5, Sn中非平凡正规子群只有An.
	- Theo 6.1.8 A5交错群是60阶单群.
	- Corollary A6是单群.
	- Theo 6.1.9 n>=5的An是单群.
- Finite Fields I
	- Theo 6.2.1 Σφ(d)=n, d是n的divisor.
	- Theo 6.2.2 G n阶有限群, 若d|n最多有d个元素满足x^d=e, 则G为循环群.
	- Theo 6.2.3 K域K'为乘法nonzero元素, K'所有有限子群是循环群
- Finite Fields II: Existence
- Finite Fields III: Uniqueness
- Cyclotomic Polynomials
- Liouville's Criterion
	- Theo 6.6.1 (Lionville). Let a be an algebraic number of degree n 2:: 2 (i.e., a IS algebraic but not rational). Then there exists a positive con- stant c (which depends only on a) such that for all integers u, v with v>0,|a- u/v| > c/v^n.
- The Irrationality of π
	- Lemma 6.7.1. If u is a real number, then lim u^n/n! = O.
