...
- **Pixor**: B Yang, W Luo, and R Urtasun. Pixor: Real-time 3d object detection from point clouds. CVPR'18
	- Key: proposal free, single-stage Detector
	- Input: BEV
	- Output: 
	- FCN:
...
- **PointRCNN**: S Shi, X Wang, H Li. PointRCNN: 3D Object Proposal Generation and Detection from Point Cloud. CVPR'19
	- Two stage RCNN detection for 3D point clouds;
...
## Fusion (LiDAR + Image)
- **MMF**: M Liang, B Yang, Y Chen, R Hu, R Urtasun. Multi-Task Multi-Sensor Fusion for 3D Object Detection. CVPR'19
	- Input: RGB, LiDAR-BEV;
